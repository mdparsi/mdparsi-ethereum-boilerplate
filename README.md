...
📒 `<Account />` :  web3 احراز هویت آسان از طریق متامسک.
...
💸 `<ERC20Transfers />` : تراکنش‌های آدرس را نشان می دهد.از ای پی آی مورالس استفاده می کند (به ارائه دهنده فعال وب 3 نیاز ندارد).
