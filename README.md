...
این استارتر به کمک [react-moralis](https://github.com/MoralisWeb3/react-moralis) و [Moralis](https://moralis.io?utm_source=github&utm_medium=readme&utm_campaign=ethereum-boilerplate) ساخته شده است. همچنین ارائه دهنده زمینه سازی برای دسترسی سریع به `chainId` or `ethAddress`
...
مرالس از محبوب ترین بلاکچین‌ها و شبکه‌های آزمایشی آنها پشتیبانی می کند.

می توانید لیستی از شبکه‌های موجود را در اینجا پیدا کنید [بلاکچین‌های مورد پشتیبانی مرالس](https://docs.moralis.io/moralis-server/web3-sdk/intro#supported-chains)
