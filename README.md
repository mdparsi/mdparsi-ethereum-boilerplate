...
می توانید لیستی از شبکه‌های موجود را در اینجا پیدا کنید [بلاکچین‌های مورد پشتیبانی مورالس](https://docs.moralis.io/moralis-server/web3-sdk/intro#supported-chains)
...
✏  فایل `.env.example` را به `.env` تغییر نام دهید و شناسه `appId` و آدرس سرور `serverUrl` مورالس خود را وارد کنید ([چگونه سرور Moralis را شروع کنیم](https://docs.moralis.io/moralis-server/getting-started/create-a-moralis-server))
مثال:
