...
- Chains (اختیاری): شبکه هایی برای نمایش.به طور پیش فرض اضافه شده است: Polygon ، ETH ، BSC و Avalanch
...
- chain (اختیاری): بلاکچینی که توکن مستقر برروی آن ساخته شده است.پیش فرض: ETH
